...
class Algo():
    ...
    def run(self):
        ...
        while not_finished:
            ...
            #start of study
            #
            bars_15m = calculations.Calculations(dataContract, "2 D", "15 mins", self.datetime_15)
            print("bars_15.cci ",bars_15m.cci)
            bars_1h = calculations.Calculations(dataContract, "5 D", "1 hour", self.datetime_1h)
            bars_1d = calculations.Calculations(dataContract, "75 D", "1 day", self.datetime_1d)
